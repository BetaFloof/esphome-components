...
async def lp5024_driver_set_led_to_code(config, action_id, template_arg, args):
...
async def lp5024_driver_set_all_led_to_code(config, action_id, template_arg, args):
    return cg.new_Pvariable(action_id, template_arg)
